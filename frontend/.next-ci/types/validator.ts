...
// Validate ../../app/api/conversations/messages/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/conversations/messages">> = Specific
  const handler = {} as typeof import("../../app/api/conversations/messages/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
